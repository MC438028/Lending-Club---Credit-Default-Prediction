...
train_data = pd.read_csv('/Users/xumoyan/Program/anaconda3/envs/cisc7201/final report/ML/train_data_preprocessed.csv', low_memory=False)
...
new_file_path = '/Users/xumoyan/Program/anaconda3/envs/cisc7201/final report/ML/train_data_encoded_sample.csv'
sampled_data.to_csv(new_file_path, index=False)
print(f"\n特征工程后的数据前200行已保存至: {new_file_path}")

# 保存完整处理后的训练数据（供特征筛选使用）
full_processed_path = '/Users/xumoyan/Program/anaconda3/envs/cisc7201/final report/ML/train_data_encoded.csv'
