...
class WeightOptimizer:
    def __init__(self,
                 cv_ranked_path='results/rq1_cv_metrics_ranked.csv',
                 output_path='results/optimized_weights.pkl'):
...
if __name__ == '__main__':
    optimizer = WeightOptimizer(
        cv_ranked_path='/Users/xumoyan/Program/anaconda3/envs/cisc7201/final report/ML/Project/results/rq1_cv_metrics_ranked.csv',
        output_path='/Users/xumoyan/Program/anaconda3/envs/cisc7201/final report/ML/Project/results/rq2_optimized_weights_modified.pkl'
    )
