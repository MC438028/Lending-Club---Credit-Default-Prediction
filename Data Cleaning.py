...
# 5. 单独删除addr_state列（无论缺失率如何）
if 'addr_state' in loan.columns and 'addr_state' not in deleted_columns:
    loan = loan.drop(columns=['addr_state'])
    deleted_columns.append('addr_state')
    print(f"阶段5: 单独删除'addr_state'列")
